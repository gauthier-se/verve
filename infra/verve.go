...
type VerveStackProps struct {
	awscdk.StackProps
}

func NewVerveStack(scope constructs.Construct, id string, props *VerveStackProps) awscdk.Stack {
...
func main() {
	...
	NewVerveStack(app, "VerveStack", &VerveStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
